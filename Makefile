...
# zncdata.net/external-secret-operator-bundle:$VERSION and zncdata.net/external-secret-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= $(RETISTRY)/external-secret-operator
...
IMG ?= $(RETISTRY)/external-secret-operator:$(VERSION)
